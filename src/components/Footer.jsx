...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/aayush-shrestha-b0441939a/", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "https://www.instagram.com/razz._.aayush/", label: "Instagram" },
    { icon: <Github size={18} />, href: "https://github.com/Aayushstha10", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "aayushshrestha003@gmail.com" },
    { icon: <Phone size={16} />, text: "+977 9824864560" },
  ];
  ...
  return (
    <footer className="px-6 py-10 mt-20">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <div>
              <p>© {currentYear} Aayush. All rights reserved.</p>
            </div>
