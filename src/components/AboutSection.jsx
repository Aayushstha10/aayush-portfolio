...
export const AboutSection = () => {
  ...
  const socialLinks = [
    {
      ...
      href: "https://github.com/Aayushstha10",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      href: "https://www.linkedin.com/in/aayush-shrestha-b0441939a/?skipRedirect=true",
    },
    { icon: <Mail className="h-5 w-5" />, href: "https://mail.google.com/mail/u/0/#inbox" },
  ];
  ...
  const tabContent = {
    ...
    professional:
      "With 6 month in full-stack development, I've delivered 3 successful projects using modern technologies. I specialize in scalable architecture and performance optimization.",
    approach:
  ...
  const handleDownload = () => {
    ...
    link.href = "/aayush.pdf"; // Must be in public folder
    link.download = "aayush.pdf";
