                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/aayush-shrestha-b0441939a/?skipRedirect=true",
                  },

                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/Aayushstha10",
                  },
                  {
                    icon: Instagram,
                    label: "Instagram",
                    url: "https://www.instagram.com/razz._.aayush/",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
