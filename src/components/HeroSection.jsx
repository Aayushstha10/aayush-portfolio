...
export const HeroSection = () => {
  ...
  const codeSnippets = [
    "import { FullStackDeveloper } from 'aayush.dev';",
    "",
  ...
  const handleViewResume = () => {
    ...
    window.open("/aayush.pdf", "_blank", "noopener,noreferrer");
  };
      ...
      <div className="container max-w-7xl mx-auto w-full mt-16 sm:mt-0">
        ...
        >
          <div className="flex-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
            <motion.div
              className="inline-flex items-center gap-2 px-4 py-2 mt-4 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium mb-8 backdrop-blur-sm"
              variants={{
                hidden: { y: 30, opacity: 0 },
                visible: { y: 0, opacity: 1, transition: { duration: 0.8 } },
              }}
            >
              <Briefcase className="h-4 w-4" /> Open to new Opportunities
            </motion.div>
