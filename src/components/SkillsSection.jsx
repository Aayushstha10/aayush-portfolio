...
const skills = [
  ...
  // Backend
  { name: "Node.js", level: 50, category: "backend", icon: "nodejs" },
  { name: "Express", level: 50, category: "backend", icon: "express" },
...
export const SkillsSection = () => {
  ...
  return (
    <section
      id="skills"
      className="py-12 px-4 bg-gradient-to-br from-background via-secondary/5 to-background"
    >
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Technologies skills I've my proficiency levels
          </p>
        </motion.div>
